...
class ThemeProvider with ChangeNotifier
{
  ...
  ThemeData themeData()
  {
    return ThemeData(
      ...
      textTheme: TextTheme(
        ...
        headline1: GoogleFonts.stickNoBills(fontSize: 70,fontWeight: FontWeight.w600,
  ...
  ThemeMode themeMode()
  {
    return ThemeMode(gradientColors: isLightTheme?
...
class ThemeMode
{
  ...
  ThemeMode({this.gradientColors,this.switchColor,this.thumbColor,this.switchBgColor});
}