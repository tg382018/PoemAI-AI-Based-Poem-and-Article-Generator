...
class _PromptTwoState extends State<PromptTwo> {
  ...
  Future <List<SavedPrompts>>readPrompts() async
  {
    ...
    final list=docs.map((doc) => SavedPrompts.fromJson(doc.data() as dynamic)).toList();
    return list;
  }
                      ...
                      child: Align(alignment: Alignment.bottomCenter,
                        child: GestureDetector(onTap: () async
                        {
                          ...
                          child: Container(width: 40,height: 40,padding: const EdgeInsets.symmetric(horizontal: 11,vertical: 12),decoration: const BoxDecoration(shape: BoxShape.circle,color: Colors.white),
                            child: Center(
                              child: Icon(
                                Icons.share,size: 18,color: Colors.black,
                              ),
                            ),
                          ),
                        ),
                      ...
                      child: Column(mainAxisAlignment: MainAxisAlignment.end,
                        children: [
                          Container(
                            ...
                            decoration:   BoxDecoration(borderRadius: BorderRadius.circular(34),gradient: LinearGradient(colors: [
                              Colors.white,
                              Colors.white54,
                            ]
                            ),boxShadow: [BoxShadow(
