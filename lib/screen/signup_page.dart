    ...
    if(isValid)
      {
        ...
        try{
              ...
              password: passwordController.text.trim()).then((value)
          {
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text("Email verification ",style: TextStyle(fontSize: 18,color: Colors.white),),
                            ],
                          ),
                          Text("Pls confirm your account with link by email",style: TextStyle(fontSize: 12,color: Colors.white),maxLines: 2,overflow: TextOverflow.ellipsis,),
                        ],
                      ),
                    ),
                  ],
            ...
            );  FirebaseAuth.instance.currentUser!.sendEmailVerification().then((value) =>  Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=>SigninPage()),(route)=>false));
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text("Please enter a valid email",style: TextStyle(fontSize: 12,color: Colors.white),maxLines: 2,overflow: TextOverflow.ellipsis,),
                ],
              ),
            ),
          ],
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text("This email already registered",style: TextStyle(fontSize: 12,color: Colors.white),maxLines: 2,overflow: TextOverflow.ellipsis,),
                ],
              ),
            ),
          ],
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text("Network error",style: TextStyle(fontSize: 12,color: Colors.white),maxLines: 2,overflow: TextOverflow.ellipsis,),
                ],
              ),
            ),
          ],
              ...
              child: SingleChildScrollView(
                ...
                GestureDetector(onTap: (){
                  ...
                  child: Container(width: 40,height: 40,padding: const EdgeInsets.symmetric(horizontal: 13,vertical: 10),decoration: const BoxDecoration(shape: BoxShape.circle,color: Colors.white),
                    ...
                    Text("SIGNUP",style: GoogleFonts.bebasNeue(fontSize: 52),),
                    SizedBox(height: 50,),
                    Form(key: formKey,
                      child: Column(
                        children: [
                          ...
                          Padding(
                            ...
                            child: Container(decoration: BoxDecoration(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.only(left:20.0),
                                child: TextFormField(style: TextStyle(color: Colors.black),validator: (value2)
                                {
                                ...
                                },obscureText: true,controller: password2Controller
                                  ,decoration: InputDecoration(hintStyle: TextStyle(color: Colors.black),
                                      border: InputBorder.none,
                          ...
                          Padding(
                            ...
                            child: GestureDetector(onTap:submitFormOnRegister
