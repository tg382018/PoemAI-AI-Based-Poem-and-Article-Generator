...
import 'package:fluttertwo/class/composition.dart';
...
int clickcount=0;
  ...
  var comp=Composition('null', 'null', 'null', 'null', 'null');
...
addSub()
{
  ...
  {
    if(comp.paragraph=='Default')
      {
        String yazi='Hello I want you to write an essay.The title of this composition should be ${comp.title},'
            'The topic of this composition should be ${comp.topic} so this composition should give information about ${comp.topic}'
            'Also, here are the keywords you can use for this essay : ${comp.keywords},Write an essay using this information.'
    ...
    else
      {
        String yazi='Hello I want you to write an essay.The title of this composition should be ${comp.title},'
            'The topic of this composition should be ${comp.topic} so this composition should give information about ${comp.topic}'
            'Also, here are the keywords you can use for this essay : ${comp.keywords},'
            'also this essay should consist of  ${comp.paragraph} words .Write an essay using this information.'
            ' Please dont write anything outside the essay.Your answer should only include the essay.';
        sendMessageToChatGPT(yazi);
      }
    print('deneme');
...
/*
    if(comp.paragraph  !='default')
    {
      if(comp.subtitles=='null')
        {
          String yazi='Hello I want you to write an essay.The title of this composition should be ${comp.title},'
              'The topic of this composition should be ${comp.topic} so this composition should give information about ${comp.topic}'
              'Also, here are the keywords you can use for this essay : ${comp.keywords},'
              'also this essay should consist of  ${comp.paragraph} paragraphs.Write an essay using this information.'
              ' Please dont write anything outside the essay.Your answer should only include the essay.';
          sendMessageToChatGPT(yazi);
        }
      else
      {
        String yazi='Hello I want you to write an essay.The title of this composition should be ${comp.title},'
            'The topic of this composition should be ${comp.topic} so this composition should give information about ${comp.topic}'
            'Also, here are the keywords you can use for this essay : ${comp.keywords},'
            'In addition, this composition should include the following sub-headings : ${comp.subtitles}'
            'also this essay should consist of  ${comp.paragraph} paragraphs.Write an essay using this information.'
            ' Please dont write anything outside the essay.Your answer should only include the essay.';
        sendMessageToChatGPT(yazi);
      }
                    ...
                    Column(
                      children: [
                        Form(key: formKey,child: Column(
                          ...
                          children: [
                            ...
                            Column(children: [
                              ...
                              Row(
                                children: [
                                  Text("Minimum word count",style: TextStyle(fontSize: 16),),
                                  SizedBox(width: 18,),
                                  Container(
                              ...
                              TextFormField(validator: (value2)
                              {
                                ...
                                {
                                 comp.title=stanza.text;

                                }
                              },controller: stanza,
                                decoration: InputDecoration(hintText: 'Enter the title of the composition'),
                              ),
                              ...
                              TextFormField(validator: (value2)
                              {
                                ...
                                else
                                {
                                  ...
                                  comp.topic=keywords.text;
                                }
                              },controller: keywords,
                                decoration: InputDecoration(hintText: 'What do you want in this essay?'),
                        ...
                        /*    GestureDetector(onTap: (){
                              ...
                              child: Row(
                                children: [
                                  AnimatedContainer(child: Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [

                                      Text('Add a subtitle (max 3)',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w900),),
                                      SizedBox(width: 4,),
                                      Icon(Icons.add,color: Colors.white,),
                                    ],
                                  ),duration:
                                  Duration(microseconds: 222),height:
                                  38,width: 180,decoration:
                            ...
                            SizedBox(height: 22,),
                            SizedBox(height: 133,width: MediaQuery.of(context).size.width-5,
                              child: Row(
                                children: [
                                  Flexible(child: ListView.builder
                                    (itemCount: sublist.length,
                                      itemBuilder: (_,index)=>sublist[index]))
                                ],
                              ),
                            ),*/
                            SizedBox(height: 22,),
  ...
  GestureDetector buildGestureDetector(BuildContext context) {
    return GestureDetector(onTap:()
    {
      if(isvalid()==true)
      {
        ...
        }).then((value) =>  Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=>PromtPage(title: prompted,whatisthis: false)),(route)=>false));
      }
    ...
    return     Container(
      ...
      child: Padding(
        ...
        child: Container(alignment: Alignment.center, // or ClipRRect if you need to clip the content
          ...
          child: Container(child: FlutterTimer(duration: Duration(seconds: 60), onFinished: (){}, timerController: TimerController(
            elevation: 4,
...
class _SubtitleWidgetState extends State<SubtitleWidget> {
  ...
  @override
  Widget build(BuildContext context) {
    return  Form(child: TextFormField(controller: sbs,validator: (value2)
    {
      if(value2!.isEmpty)
      {
        return   'It can not be empty';
