...
class _NormalFormPageState extends State<NormalFormPage> {
  ...
  void submitForm() async {
    ...
    if (info.acrostic != 'yes') {
      String yazi =
          'I want you to compose a poem. Please dont give any explanations when you write this poem.'
          'Just write the poem. \n  ,'
                                      ...
                                      TextFormField(
                                        ...
                                        validator: (value2) {
                                          if (value2!.isEmpty) {
                                            ...
                                            info.stanza =
                                                int.parse(stanza.text);
                                          }
                                        },
                                        controller: stanza,
                                        decoration: InputDecoration(
                                            hintText:
                                                'Enter min a stanza number'),
                                      ),
                                      TextFormField(
                                        validator: (value2) {
                                          if (value2!.isEmpty) {
        ...
        if (isvalid() == true) {
          ...
          Future.delayed(Duration(seconds: 15), () {
            setState(() {
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      PromtPage(title: prompted, whatisthis: true)),
              (route) => false));
        }
      }
      //submitForm,
