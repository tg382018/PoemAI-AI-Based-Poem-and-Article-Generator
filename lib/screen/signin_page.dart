                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Text("Signin Successful",style: TextStyle(fontSize: 18,color: Colors.white),),
                              ],
                            ),
                            Text("You joined successfully",style: TextStyle(fontSize: 12,color: Colors.white),maxLines: 2,overflow: TextOverflow.ellipsis,),
                          ],
                        ),
                      ),
                    ],
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                Icon(Icons.account_circle,color: Colors.white,),
                                Text("Email Confirmation",style: TextStyle(fontSize: 18,color: Colors.white),),
                              ],
                            ),
                            Text("You didnt confirm email yet",style: TextStyle(fontSize: 12,color: Colors.white),maxLines: 2,overflow: TextOverflow.ellipsis,),
                          ],
                        ),
                      ),
                    ],
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Wrong email or password',style: TextStyle(fontSize: 12,color: Colors.white),maxLines: 2,overflow: TextOverflow.ellipsis,),
                    ],
                  ),
                ),
              ],
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(width: 222,height:222,child: Image.asset("lib/assets/scf.png",)),
                          Text("Hello FAM!",style: GoogleFonts.bebasNeue(fontSize: 52),),
                     SizedBox(height: 10,),
                        Text("PoemAI is waiting for you",style: GoogleFonts.neucha(fontSize: 22)),
                        SizedBox(height: 50,),
                        Padding(
                          ...
                          child: Container(decoration: BoxDecoration(
                            ...
                            child: Padding(
                              ...
                              },controller: emailController,style: TextStyle(color: Colors.black),decoration: InputDecoration(hintStyle: TextStyle(color: Colors.black),
...
SizedBox(height: 10,),
                        Padding(
                          ...
                          child: Container(decoration: BoxDecoration(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.only(left:20.0),
                              child: TextFormField(style: TextStyle(color: Colors.black),validator: (value)
                              {
                                if(value!.isEmpty)
                                {
                                  return   'It can not be empty';
                        ...
                        Padding(
                          ...
                          child: GestureDetector(onTap: submitFormOnlogin
                            ...
                            GestureDetector(onTap: (){
                              ...
                              child: AnimatedContainer(child: Row(
                                ...
                                children: [
                                  ...
                                  Text('Register Now',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w600),),
                                ],
                              ),duration:
                              Duration(microseconds: 222),height:
                              35,width: 120,decoration:
  ...
  Future openDialog() =>showDialog(context: context, builder: (context)=>
      AlertDialog(
        ...
        content: Container(height: MediaQuery.of(context).size.height/3,
          child: Form(key:emailkey ,
            child: Column(children: [
              TextFormField(
                ...
                },controller: emailsent,decoration: InputDecoration(hintText: 'Write your email'),
              ),
              SizedBox(height: 5,),
              TextButton(onPressed:buttonClicked ? ()
              {
                setState(() {
                  buttonClicked=false;
                });
