...
import 'package:fluttertwo/screen/Forms/betamodelform.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                      width: 111,
                      child:
                          Container(child: Image.asset("lib/assets/scf.png"))),
                  SizedBox(
                      width: size.width * .4,
                      child: Divider(
                        color: Colors.white,
                  ...
                  InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => AcrosticFormPage()));
                      }
                      //AcrosticFormPage()
                      ,
                      child: Container(
                          height: 90,
                          child: Image.asset("lib/assets/acrosticbutton.png"))),
                  SizedBox(
                    height: 13,
                  ),
                  GestureDetector(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => NormalFormPage()));
                      },
                      child: SizedBox(
                          height: 90,
                          child: Container(
                              child: Image.asset(
                                  "lib/assets/normalpoembutton.png")))),
                  SizedBox(
                    height: 13,
                  ),
                  GestureDetector(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => CompositionForm()));
                      },
                      child: SizedBox(
                          height: 90,
                          child: Container(
                              child: Image.asset(
                                  "lib/assets/articlebutton.png")))),
                ],
              ),
            )),
            GestureDetector(
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => BetaModelForm()));
              },
              child: Column(
