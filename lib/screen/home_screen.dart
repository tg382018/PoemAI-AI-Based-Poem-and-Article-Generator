...
import 'package:fluttertwo/screen/acrosticform.dart';
...
bottomNavigationBar: SizedBox(height: 52,
  child:   Container(color: Colors.black,
    child:   GNav(color: Colors.white,textStyle: TextStyle(color: Colors.white),tabBackgroundColor: Colors.grey.shade800,padding: EdgeInsets.all(16),
      tabs: [
        GButton(onPressed: (){
          Navigator.push(context, MaterialPageRoute(builder: (context)=>AcrosticFormPage()));
        ...
        GButton(onPressed: (){
        //  Navigator.push(context, MaterialPageRoute(builder: (context)=>PromtPage()));
       ...
       SizedBox(width:size.width*.4,child: Divider(color: Colors.white,)),
        Text("BEST",style: Theme.of(context).textTheme.headline1,),
          ...
          style: TextStyle(fontSize: 40,fontWeight: FontWeight.bold),),
                  SizedBox(height: 39,),
                  SizedBox(height:90,child: Container(child: Image.asset("lib/assets/acrosticbutton.png"))),
                  SizedBox(height: 13,),
                  SizedBox(height:90,child: Container(child: Image.asset("lib/assets/normalpoembutton.png"))),
                  SizedBox(height: 13,),
                  SizedBox(height:90,child: Container(child: Image.asset("lib/assets/articlebutton.png"))),
            ...
            Wire(initialPosition: initialPosition,toOffset: switchPosition,),
          AnimatedPositioned(
