                  ...
                  Container(height: MediaQuery.of(context).size.height/3,
                    child: Form(key:emailkey ,
                      child: Column(mainAxisAlignment: MainAxisAlignment.center,children: [
                        ...
                        Text("RESET PASSWORD",style: GoogleFonts.bebasNeue(fontSize: 52),),
                        SizedBox(height: 8,),
                        TextFormField(
                          validator: (value)
                          {
                        ...
                        TextButton(onPressed:buttonClicked ? ()
                        {
                          setState(() {
                            ...
                            if(isValid) {
                              FirebaseAuth.instance.sendPasswordResetEmail(email: emailsent.text.trim());
                              setState(() {
                                buttonClicked=false;
                                ScaffoldMessenger.of(context).showSnackBar(SnackBar(content:
                                Stack(
                                    children: [Container(
                                      padding: EdgeInsets.all(16),width: MediaQuery.of(context).size.width-5,
                                            ...
                                            children: [
                                              Row(
                                                children: [
                                                  ...
                                                  Text("Request Mail Sent",style: TextStyle(fontSize: 18,color: Colors.white),),
                                                ],
                                              ),
                                              Text("If the e-mail you entered is registered in/nthe system\nwe have sent an e-mail. Please check your inbox.",style: TextStyle(fontSize: 13,color: Colors.white),maxLines: 2,overflow: TextOverflow.ellipsis,),
                                            ],
                                          ),
                                        ),
                                      ],
